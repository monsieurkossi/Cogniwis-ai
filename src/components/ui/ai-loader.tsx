...
// Full-screen AI-style loader — blue-gradient background with the letters of
// `text` popping one after the other while an inset shadow-ring rotates.
// Uses styled-jsx (bundled in Next.js) — requires the "use client" directive.
